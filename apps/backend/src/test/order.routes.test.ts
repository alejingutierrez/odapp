...
import { OrderStatus, FinancialStatus, FulfillmentStatus, PaymentMethod, PaymentStatus, ReturnStatus } from '@prisma/client';
...
describe('Order Routes', () => {
  ...
  describe('POST /api/orders', () => {
    ...
    it('should create order successfully', async () => {
      ...
      expect(mockOrderService.createOrder).toHaveBeenCalledWith(validOrderData, 'user-1');
    });
    ...
    it('should handle service errors', async () => {
      mockOrderService.createOrder.mockRejectedValue(new Error('Insufficient inventory'));
  ...
  describe('GET /api/orders', () => {
    ...
    it('should get orders with default pagination', async () => {
      ...
      expect(mockOrderService.getOrders).toHaveBeenCalledWith({}, 1, 20, 'createdAt', 'desc');
    });
  ...
  describe('PUT /api/orders/:id', () => {
    ...
    it('should update order successfully', async () => {
      ...
      expect(mockOrderService.updateOrder).toHaveBeenCalledWith('order-1', updateData, 'user-1');
    });
  ...
  describe('POST /api/orders/:id/payments', () => {
    ...
    it('should process payment successfully', async () => {
      ...
      expect(mockOrderService.processPayment).toHaveBeenCalledWith('order-1', paymentData, 'user-1');
    });
  ...
  describe('POST /api/orders/:id/fulfillments', () => {
    ...
    it('should create fulfillment successfully', async () => {
      ...
      expect(mockOrderService.createFulfillment).toHaveBeenCalledWith('order-1', fulfillmentData, 'user-1');
    });
  ...
  describe('POST /api/orders/:id/fulfillments/:fulfillmentId/ship', () => {
    ...
    it('should ship fulfillment successfully', async () => {
      ...
      expect(mockOrderService.shipFulfillment).toHaveBeenCalledWith('fulfillment-1', 'user-1');
    });
  });
  ...
  describe('POST /api/orders/:id/returns', () => {
    ...
    it('should create return successfully', async () => {
      ...
      expect(mockOrderService.createReturn).toHaveBeenCalledWith('order-1', returnData, 'user-1');
    });
  ...
  describe('POST /api/orders/:id/returns/:returnId/process', () => {
    ...
    it('should approve return successfully', async () => {
      ...
      expect(mockOrderService.processReturn).toHaveBeenCalledWith('return-1', true, 50.00, 'user-1');
    });
    ...
    it('should reject return successfully', async () => {
      ...
      expect(response.body.success).toBe(true);
      expect(mockOrderService.processReturn).toHaveBeenCalledWith('return-1', false, undefined, 'user-1');
    });
    ...
    it('should validate approve field', async () => {
      ...
      expect(response.body.success).toBe(false);
      expect(response.body.message).toBe('approve field is required and must be boolean');
  ...
  describe('POST /api/orders/:id/cancel', () => {
    ...
    it('should cancel order successfully', async () => {
      ...
      expect(mockOrderService.cancelOrder).toHaveBeenCalledWith('order-1', 'Customer request', 'user-1');
    });
    ...
    it('should cancel order without reason', async () => {
      ...
      expect(response.body.success).toBe(true);
      expect(mockOrderService.cancelOrder).toHaveBeenCalledWith('order-1', undefined, 'user-1');
    });
  });
  ...
  describe('GET /api/orders/analytics', () => {
    ...
    it('should get order analytics', async () => {
      ...
      expect(mockOrderService.getOrderAnalytics).toHaveBeenCalledWith(undefined, undefined, undefined);
    });
