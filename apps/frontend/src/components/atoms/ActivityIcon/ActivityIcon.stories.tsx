...
const meta: Meta<typeof ActivityIcon> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'Icons for different activity types like calls, emails, meetings, and interaction indicators for CRM systems.',
      },
    },
  },
  tags: ['autodocs'],
...
export const WithBackground: Story = {
  render: () => (
    <Space wrap size="large">
      ...
      <ActivityIcon type="email" showBackground tooltip="Email with background" />
      <ActivityIcon type="meeting" showBackground tooltip="Meeting with background" />
      <ActivityIcon type="purchase" showBackground tooltip="Purchase with background" />
  ...
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', padding: '16px' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
        ...
        <span style={{ marginLeft: 'auto', color: '#666', fontSize: '12px' }}>2 hours ago</span>
      </div>
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
        <ActivityIcon type="email" showBackground />
        <span>Sent product catalog via email</span>
        <span style={{ marginLeft: 'auto', color: '#666', fontSize: '12px' }}>1 hour ago</span>
      </div>
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
        <ActivityIcon type="meeting" showBackground />
        <span>Scheduled demo meeting</span>
        <span style={{ marginLeft: 'auto', color: '#666', fontSize: '12px' }}>30 minutes ago</span>
      </div>
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
        <ActivityIcon type="purchase" showBackground />
        <span>Customer placed order #12345</span>
        <span style={{ marginLeft: 'auto', color: '#666', fontSize: '12px' }}>Just now</span>
      </div>
    </div>
  ),
}