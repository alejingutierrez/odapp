...
describe('Chip', () => {
  ...
  it('shows close button when removable', () => {
    ...
    const { container } = render(<Chip label="Test" removable onRemove={handleRemove} />);
  ...
  it('renders with icon', () => {
    const { container } = render(<Chip label="Test" icon={<span data-testid="test-icon">Icon</span>} />);
