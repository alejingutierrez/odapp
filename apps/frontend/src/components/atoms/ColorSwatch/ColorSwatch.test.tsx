...
describe('ColorSwatch Component', () => {
  ...
  it('does not call onClick when disabled', () => {
    const handleClick = vi.fn()
    const { container } = render(
      <ColorSwatch color='#ff0000' onClick={handleClick} disabled />
    )
  ...
  it('shows tooltip when name is provided', () => {
    const { container } = render(
      <ColorSwatch color='#ff0000' name='Red' showTooltip />
    )
    const swatch = container.querySelector('.oda-color-swatch')
  ...
  it('meets accessibility standards', async () => {
    ...
    expect(container.querySelector('.oda-color-swatch')).toBeInTheDocument()
  })
})
...
describe('ColorPalette Component', () => {
  ...
  it('meets accessibility standards', async () => {
    ...
    // TODO: Implement accessibility check
    expect(container.querySelector('.oda-color-palette')).toBeInTheDocument()
  })
})
