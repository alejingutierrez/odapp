...
describe('DateTimePicker', () => {
  ...
  it('displays placeholder correctly', () => {
    ...
    expect(container.querySelector('input[placeholder="Select date"]')).toBeInTheDocument();
  });

  it('handles value changes', () => {
    const handleChange = vi.fn();
    const testDate = dayjs('2024-01-15');
    const { container } = render(<DateTimePicker value={testDate} onChange={handleChange} />);
