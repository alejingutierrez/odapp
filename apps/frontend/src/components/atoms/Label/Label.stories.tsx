...
const meta: Meta<typeof Label> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'Label component for form fields and content labeling with various sizes, weights, and colors.',
      },
    },
  },
  tags: ['autodocs'],
...
export const RequiredVariations: Story = {
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
      ...
      <Label required color="error">Required Error Field</Label>
      <Label required size="large" weight="bold">Large Required Field</Label>
      <Label required size="small" color="secondary">Small Required Field</Label>
    </div>
  ),
}
...
export const FormFieldExamples: Story = {
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px', maxWidth: '300px' }}>
      ...
      <div>
        <Label htmlFor="email" required color="default">Email Address</Label>
        <input 
          id="email" 
          type="email" 
      ...
      <div>
        <Label htmlFor="bio" size="small" color="secondary">Bio (Optional)</Label>
        <textarea 
          id="bio" 
...
export const StatusLabels: Story = {
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
      <div>
        <Label color="success" weight="semibold">✓ Valid Field</Label>
      ...
      <div>
        <Label color="warning" weight="semibold">⚠ Warning Field</Label>
      ...
      <div>
        <Label color="error" weight="semibold">✗ Error Field</Label>
  ...
  render: () => (
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '16px', textAlign: 'center' }}>
      <div>
        ...
        <Label size="small" weight="normal">Normal</Label>
        <br />
        <Label size="small" weight="medium">Medium</Label>
        <br />
        <Label size="small" weight="semibold">Semibold</Label>
        <br />
        <Label size="small" weight="bold">Bold</Label>
      </div>
      
      <div>
        <div style={{ fontSize: '12px', marginBottom: '8px', color: '#666' }}>Medium</div>
        <Label size="medium" weight="normal">Normal</Label>
        <br />
        <Label size="medium" weight="medium">Medium</Label>
        <br />
        <Label size="medium" weight="semibold">Semibold</Label>
        <br />
        <Label size="medium" weight="bold">Bold</Label>
      </div>
      
      <div>
        <div style={{ fontSize: '12px', marginBottom: '8px', color: '#666' }}>Large</div>
        <Label size="large" weight="normal">Normal</Label>
        <br />
        <Label size="large" weight="medium">Medium</Label>
        <br />
        <Label size="large" weight="semibold">Semibold</Label>
        <br />
        <Label size="large" weight="bold">Bold</Label>
      </div>
    </div>
  ),
}
...
export const AccessibilityExample: Story = {
  render: () => (
    <div style={{ maxWidth: '400px' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
        <div>
          <Label htmlFor="accessible-name" required>Full Name</Label>
          <input 
            id="accessible-name"
            type="text"
        ...
        <div>
          <Label htmlFor="accessible-email" required>Email</Label>
          <input 
            id="accessible-email"
            type="email"
          ...
          />
          <div id="email-help" style={{ fontSize: '12px', color: '#666', marginTop: '4px' }}>
