...
describe('MaterialTag', () => {
  ...
  it('applies variant classes correctly', () => {
    const { container } = render(<MaterialTag material="Cotton" variant="detailed" />);
  ...
  it('shows close button when removable', () => {
    ...
    const { container } = render(<MaterialTag material="Cotton" removable onRemove={handleRemove} />);
  ...
  it('applies custom className', () => {
    const { container } = render(<MaterialTag material="Cotton" className="custom-class" />);
