...
export const AllVariants: Story = {
  render: () => (
    <div style={{ display: 'flex', gap: 32, alignItems: 'center' }}>
      ...
      <ProgressIndicator percent={60} variant="circle" label="Circle Progress" />
      <ProgressIndicator percent={45} variant="dashboard" label="Dashboard Progress" />
    </div>
  ),
};
...
export const CircleSizes: Story = {
  render: () => (
    <div style={{ display: 'flex', gap: 32, alignItems: 'center' }}>
      <ProgressIndicator percent={75} variant="circle" size="small" label="Small Circle" />
      <ProgressIndicator percent={75} variant="circle" size="default" label="Default Circle" />
      <ProgressIndicator percent={75} variant="circle" size="large" label="Large Circle" />
    </div>
  ),
};
