...
const meta: Meta<typeof Spinner> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'Modern, accessible spinner component with multiple variants, sizes, and colors. Built with performance and accessibility in mind.',
      },
    },
  },
  tags: ['autodocs'],
  ...
  render: () => (
    <div style={{ display: 'flex', alignItems: 'center', gap: '24px', flexWrap: 'wrap' }}>
      ...
      <div style={{ 
        ...
        <div style={{ fontSize: '12px', marginTop: '8px', color: 'white' }}>White</div>
      </div>
    </div>
  ),
}
...
export const LoadingButtons: Story = {
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', alignItems: 'flex-start' }}>
      ...
      <Button type="primary" style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
