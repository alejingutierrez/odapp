...
describe('ActivityIcon', () => {
  ...
  it('applies size classes correctly', () => {
    ...
    expect(
      container.querySelector('.oda-activity-icon--large')
    ).toBeInTheDocument()
  })
  ...
  it('applies variant classes correctly', () => {
    ...
    expect(
      container.querySelector('.oda-activity-icon--primary')
    ).toBeInTheDocument()
  })
  ...
  it('shows background when enabled', () => {
    ...
    expect(
      container.querySelector('.oda-activity-icon--with-background')
    ).toBeInTheDocument()
  })
  ...
  it('applies active state', () => {
    ...
    expect(
      container.querySelector('.oda-activity-icon--active')
    ).toBeInTheDocument()
  })
  ...
  it('applies disabled state', () => {
    ...
    expect(
      container.querySelector('.oda-activity-icon--disabled')
    ).toBeInTheDocument()
  })
