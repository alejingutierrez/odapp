...
describe('RatingInput', () => {
  ...
  it('renders emoji rating type', () => {
    ...
    expect(
      container.querySelector('.oda-rating-input--emoji')
    ).toBeInTheDocument()
  })
  ...
  it('renders heart rating type', () => {
    ...
    expect(
      container.querySelector('.oda-rating-input--heart')
    ).toBeInTheDocument()
  })
  ...
  it('renders thumbs rating type', () => {
    ...
    expect(
      container.querySelector('.oda-rating-input--thumbs')
    ).toBeInTheDocument()
  })
  ...
  it('applies size classes correctly', () => {
    ...
    expect(
      container.querySelector('.oda-rating-input--large')
    ).toBeInTheDocument()
  })
  ...
  it('handles readonly state', () => {
    ...
    expect(
      container.querySelector('.oda-rating-input--readonly')
    ).toBeInTheDocument()
  })
