...
describe('TaxRateDisplay', () => {
  ...
  it('renders tax amount when provided', () => {
    render(<TaxRateDisplay rate={8.25} amount={16.50} currency="$" />)
    expect(screen.getByText('8.25%')).toBeInTheDocument()
  ...
  it('renders compact variant', () => {
    ...
    expect(container.querySelector('.oda-tax-rate-display--compact')).toBeInTheDocument()
  ...
  it('renders detailed variant with region', () => {
    ...
    expect(container.querySelector('.oda-tax-rate-display--detailed')).toBeInTheDocument()
  ...
  it('renders badge variant', () => {
    ...
    expect(container.querySelector('.oda-tax-rate-display--badge')).toBeInTheDocument()
  })

  it('applies size classes correctly', () => {
    const { container } = render(<TaxRateDisplay rate={8.25} size="large" />)
    expect(container.querySelector('.oda-tax-rate-display--large')).toBeInTheDocument()
  })

  it('shows breakdown tooltip when provided', () => {
    const breakdown = [
      { name: 'State Tax', rate: 5.0, amount: 10.00, type: 'state' as const },
      { name: 'Local Tax', rate: 3.25, amount: 6.50, type: 'local' as const },
    ]
