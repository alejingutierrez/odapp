...
describe('Toggle', () => {
  ...
  it('applies size classes correctly', () => {
    const { container } = render(<Toggle label="Large Toggle" size="large" />)
    expect(container.querySelector('.oda-toggle--large')).toBeInTheDocument()
  })

  it('applies variant classes correctly', () => {
    const { container } = render(<Toggle label="Primary Toggle" variant="primary" />)
  ...
  it('positions label correctly', () => {
    ...
    expect(container.querySelector('.oda-toggle--label-left')).toBeInTheDocument()
  })
