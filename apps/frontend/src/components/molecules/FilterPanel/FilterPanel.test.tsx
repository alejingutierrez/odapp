...
describe('FilterPanel', () => {
  ...
  it('renders filter panel title', () => {
    render(<FilterPanel sections={mockSections} title='Custom Filters' />)
  ...
  it('renders collapsible panel when collapsible is true', () => {
    render(
      <FilterPanel sections={mockSections} collapsible={true} title='Filters' />
    )
  ...
  it('applies custom className', () => {
    render(
      <FilterPanel sections={mockSections} className='custom-filter-panel' />
    )
