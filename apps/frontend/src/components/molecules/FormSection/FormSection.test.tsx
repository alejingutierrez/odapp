...
describe('FormSection', () => {
  ...
  it('shows required indicator when required is true', () => {
    ...
    expect(document.querySelector('.form-section__required-indicator')).toBeInTheDocument()
  })
  ...
  it('applies different collapsible states', () => {
    ...
    expect(document.querySelector('.form-section--collapsible')).toBeInTheDocument()
  ...
  it('renders with disabled state', () => {
    ...
    expect(document.querySelector('.form-section__content--disabled')).toBeInTheDocument()
  })
})
