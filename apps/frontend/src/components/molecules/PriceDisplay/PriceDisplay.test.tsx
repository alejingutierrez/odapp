...
describe('PriceDisplay', () => {
  ...
  it('uses custom currency and locale', () => {
    render(<PriceDisplay price={29.99} currency='EUR' locale='de-DE' />)
  ...
  it('renders in vertical layout', () => {
    render(
      <PriceDisplay price={29.99} compareAtPrice={39.99} layout='vertical' />
    )

    expect(
      document.querySelector('.price-display--vertical')
    ).toBeInTheDocument()
  })
