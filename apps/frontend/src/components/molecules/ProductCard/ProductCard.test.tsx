...
describe('ProductCard', () => {
  const mockProduct = {
    ...
    images: [
      { id: '1', url: 'https://example.com/product.jpg', alt: 'Test Product', position: 1 }
    ],
    variants: [
      { id: '1', price: 99.99, sku: 'TEST-001', inventory: 10 }
    ],
  ...
  it('renders product card with basic information', () => {
    ...
    expect(screen.getByRole('img', { name: 'Test Product' })).toHaveAttribute('src', mockProduct.images[0].url)
  })
