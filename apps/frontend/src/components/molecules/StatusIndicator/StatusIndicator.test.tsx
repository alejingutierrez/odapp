...
describe('StatusIndicator', () => {
  ...
  it('hides icon when showIcon is false', () => {
    ...
    expect(document.querySelector('.status-indicator__icon')).not.toBeInTheDocument()
  })
  ...
  it('renders different status types correctly', () => {
    const statuses = ['success', 'error', 'warning', 'pending', 'cancelled'] as const
  ...
  it('applies size classes correctly', () => {
    const { rerender } = render(<StatusIndicator status="success" size="small" />)
    
    expect(document.querySelector('.status-indicator__text--small')).toBeInTheDocument()
    
    rerender(<StatusIndicator status="success" size="large" />)
    expect(document.querySelector('.status-indicator__text--large')).toBeInTheDocument()
  })
